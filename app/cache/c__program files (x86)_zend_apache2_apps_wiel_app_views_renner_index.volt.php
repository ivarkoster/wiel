...
<div class="login-or-signup">
	<div class="row">
        <div class="col-lg-6">
            ...
            <?php echo Phalcon\Tag::form(array('renner/add', 'id' => 'registerForm', 'onbeforesubmit' => 'return false')); ?>
			...
			<div class="form-group">
				<label for="tussenvoegsel">Tussenvoegsel</label>
		  		<div class="input-group">
	   				<?php echo Phalcon\Tag::textField(array('tussenvoegsel', 'class' => 'form-control', 'id' => 'tussenvoegsel', 'placeholder' => 'Tussenvoegsel')); ?>
		  		</div>
	        </div>
			...
			<div class="form-group">
				<label for="dob">Geboren op</label>
		  		<div class="input-group">
	   				<?php echo Phalcon\Tag::textField(array('dob', 'class' => 'form-control datepicker', 'id' => 'datepicker', 'placeholder' => 'Geboorte datum')); ?>
		  		</div>
	        </div>
	        ...
	        $(document).ready(function () {
	  		...
	  		<div class="form-group">
	  		<br />
	  			<?php echo Phalcon\Tag::submitButton(array('Opslaan', 'class' => 'btn btn-primary', 'name' => 'opslaan', 'onclick' => 'return Renner.validate();')); ?>
	  		</div>
	  		</form>
        </div>
