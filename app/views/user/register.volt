        ...
        <div class="col-lg-6">
			...
			<div class="form-group">
				<label for="email">E-mail adres</label>
		  		<div class="input-group">
	   				{{ text_field('email', 'class':'form-control', 'id':'email', 'placeholder':'E-mail') }}
	                <span class="input-group-addon"><span class="glyphicon glyphicon-star"></span></span>
		  		</div>
			...
			<div class="form-group">
				<label for="password1">Wachtwoord</label>
		  		<div class="input-group">
	   				{{ password_field('password1', 'class':'form-control', 'id':'password1', 'placeholder':'Wachtwoord') }}
	                <span class="input-group-addon"><span class="glyphicon glyphicon-star"></span></span>
		  		</div>
			...
			<div class="form-group">
				<label for="password2">Wachtwoord verifi&euml;ren</label>
		  		<div class="input-group">
	   				{{ password_field('password2', 'class':'form-control', 'id':'password2', 'placeholder':'Wachtwoord verifi&euml;ren') }}
	                <span class="input-group-addon"><span class="glyphicon glyphicon-star"></span></span>
		  		</div>
	  		...
	  		<div class="form-group">
	  			{{ submit_button('Registreren', 'class': 'btn btn-primary', 'name': 'register', 'onclick': 'return SignUp.validate();') }}
	  		</div>
	  		</form>
        </div>
